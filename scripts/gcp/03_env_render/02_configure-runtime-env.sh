...
ask(db, db_order, "APP_DB_CIDR", "App VM private CIDR allowed in pg_hba.conf", get(db, "APP_DB_CIDR", ""))
...
ask(app, app_order, "TAILSCALE_ADVERTISE_ROUTES", "App subnet routes to advertise", get(app, "TAILSCALE_ADVERTISE_ROUTES", infra.get("APP_TAILSCALE_ROUTES", "")))
