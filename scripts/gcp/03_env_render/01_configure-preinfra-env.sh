...
ask("APP_BOOT_DISK_SIZE_GB", "App boot disk size GB", get("APP_BOOT_DISK_SIZE_GB") or get("BOOT_DISK_SIZE_GB") or "10")
ask("DB_BOOT_DISK_SIZE_GB", "DB boot disk size GB", get("DB_BOOT_DISK_SIZE_GB") or get("BOOT_DISK_SIZE_GB") or "20")
