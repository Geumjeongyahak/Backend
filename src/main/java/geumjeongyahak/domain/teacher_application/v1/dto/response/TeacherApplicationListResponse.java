...
@Schema(description = "교원 신청 목록 응답")
public record TeacherApplicationListResponse(
    ...
    public static TeacherApplicationListResponse from(TeacherApplication application) {
        Subject preferredSubject = application.getPreferredSubject();
        return new TeacherApplicationListResponse(
            application.getId(),
