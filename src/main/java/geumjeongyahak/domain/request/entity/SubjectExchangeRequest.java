...
@Entity
@Getter
@Table(name = "subject_exchange_requests")
@NoArgsConstructor(access = AccessLevel.PROTECTED)
public class SubjectExchangeRequest extends BaseEntity {
    ...
    public SubjectExchangeRequest(Subject subject, User requestedBy, String title, String content) {
