package sonmoeum.domain.channel.v1.dto.response;
...
public record ChannelResponse(
    ...
    public static ChannelResponse from(Channel channel) {
        Long classroomId = channel.getChannelType() == sonmoeum.domain.channel.enums.ChannelType.CLASSROOM
                ? channel.getRefId()
                : null;
        Long departmentId = channel.getChannelType() == sonmoeum.domain.channel.enums.ChannelType.DEPARTMENT
                ? channel.getRefId()
                : null;
        ...
        return new ChannelResponse(
                ...
                classroomId,
                departmentId,
                channel.getChannelType() == sonmoeum.domain.channel.enums.ChannelType.CUSTOM
                        ? channel.getRefId()
                        : null,
