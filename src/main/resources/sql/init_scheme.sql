...
CREATE INDEX idx_purchase_requests_subject_id ON purchase_requests(subject_id);
...
CREATE INDEX idx_subject_exchange_requests_subject_id ON subject_exchange_requests(subject_id);
