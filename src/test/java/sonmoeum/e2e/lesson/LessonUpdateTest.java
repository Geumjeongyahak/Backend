...
public class LessonUpdateTest extends LessonBaseTest {
    ...
    void patchLesson_success_partialFields() {
        ...
        Long lessonId = createLessonAndGetId(
            createLessonRequest(subjectId, TEACHER_ID, "2026-02-20", "19:20:00", "20:00:00", 1),
            adminAccessToken
        );
    ...
    void patchLesson_invalidTime_400() {
        ...
        Long lessonId = createLessonAndGetId(
            createLessonRequest(subjectId, TEACHER_ID, "2026-02-22", "19:20:00", "20:00:00", 1),
            adminAccessToken
        );
        createdLessonIds.add(lessonId);
    ...
    void patchLesson_conflict_409() {
        ...
        Long lessonA = createLessonAndGetId(
            createLessonRequest(subjectId, TEACHER_ID, "2026-02-23", "19:00:00", "20:00:00", 1),
            adminAccessToken
        );
        createdLessonIds.add(lessonA);

        Long lessonB = createLessonAndGetId(
            createLessonRequest(subjectId, TEACHER_ID, "2026-02-23", "20:10:00", "21:00:00", 2),
            adminAccessToken
        );
        createdLessonIds.add(lessonB);
    ...
    void patchLesson_forbidden_403() {
        ...
        Long lessonId = createLessonAndGetId(
            createLessonRequest(subjectId, TEACHER_ID, "2026-02-24", "19:20:00", "20:00:00", 1),
            adminAccessToken
        );
        createdLessonIds.add(lessonId);
