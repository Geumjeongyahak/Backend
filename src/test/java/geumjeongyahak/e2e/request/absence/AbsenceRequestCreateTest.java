...
class AbsenceRequestCreateTest extends RequestBaseTest {
    ...
    void createAbsenceRequest_asVolunteer_returns201() {
        ...
        createdRequestId = given()
            ...
            .body(absenceRequestBody(createdLessonId, "개인 사정 결석", "개인 사정"))
            .post()
            .then()
            .statusCode(201)
    ...
    void createAbsenceRequest_asAdminTeacher_returns201() {
        ...
        createdRequestId = given()
            ...
            .contentType(ContentType.JSON)
            .body(absenceRequestBody(createdLessonId, "관리자 결석", "관리자 결석 사유"))
            .post()
            .then()
            .statusCode(201)
    ...
    void createAbsenceRequest_duplicatePending_returns409() {
        ...
        given()
            ...
            .header(AUTH_HEADER, getAuthHeader(volunteerToken))
            .contentType(ContentType.JSON)
            .body(absenceRequestBody(createdLessonId, "중복 결석", "중복 결석 요청"))
            .post()
            .then()
            .statusCode(409);
    }
    ...
    void createAbsenceRequest_duplicateApproved_returns409() {
        ...
        given()
            ...
            .header(AUTH_HEADER, getAuthHeader(volunteerToken))
            .contentType(ContentType.JSON)
            .body(absenceRequestBody(createdLessonId, "승인 후 중복 결석", "승인 후 중복 결석 요청"))
            .post()
            .then()
            .statusCode(409);
    }
    ...
    void createAbsenceRequest_afterRejected_returns201() {
        ...
        createdRequestId2 = given()
            ...
            .header(AUTH_HEADER, getAuthHeader(volunteerToken))
            .contentType(ContentType.JSON)
            .body(absenceRequestBody(createdLessonId, "반려 후 재요청", "반려 후 재요청"))
            .post()
            .then()
            .statusCode(201)
            .body("status", equalTo("PENDING"))
    ...
    void createAbsenceRequest_afterCancelled_returns201() {
        ...
        createdRequestId2 = given()
            ...
            .header(AUTH_HEADER, getAuthHeader(volunteerToken))
            .contentType(ContentType.JSON)
            .body(absenceRequestBody(createdLessonId, "취소 후 재요청", "취소 후 재요청"))
            .post()
            .then()
            .statusCode(201)
            .body("status", equalTo("PENDING"))
    ...
    private Map<String, Object> absenceRequestBody(Long lessonId, String reason) {
        return absenceRequestBody(lessonId, "결석 요청", reason);
    }
